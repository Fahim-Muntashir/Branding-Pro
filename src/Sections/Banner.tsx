                        ...
                        <div className="container mx-auto h-full ">
                            <header className="container flex items-center h-full lg:mt-0">
                                <div className="w-full mt-20">
                                    ...
                                    <p className="text-6xl font-bold mb-10 text-dark">I Design America’s Most <span className="text-primary">trusted Garage Door</span> service websites and brands
                                    </p>
                                    <Link href="#meet"
