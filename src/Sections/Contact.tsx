...
const Contact = () => {
    ...
    return (
        <Container>
            <section
                className="relative z-10 overflow-hidden  dark:bg-dark py-20 lg:py-[120px]"
                id="contact"
            >
                <div className="container mx-auto">
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                        ...
                        <div className="w-full px-1 lg:w-1/2 xl:w-5/12">
                            <div className="relative p-2 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
